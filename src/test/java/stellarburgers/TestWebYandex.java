...
public class TestWebYandex
{
    public static class RegistrationTests extends TestBaseYandex
    {
        @Test
    ...
    public static class LogInTest extends TestBaseYandex
    {
        @Test
    ...
    public static class TransitionToPersonalRoomTest extends TestBaseYandex
    {
        @Test
    ...
    public static class TransitionFromPersonalRoomToConstructorTest extends TestBaseYandex
    {
        @Test
    ...
    public static class ExitFromAccountTest extends TestBaseYandex
    {
        @Test
    ...
    public static class ConstructorTests extends TestBaseYandex
    {
        @Test
